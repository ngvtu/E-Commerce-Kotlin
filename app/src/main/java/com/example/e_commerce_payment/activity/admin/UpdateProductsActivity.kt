...
import com.example.e_commerce_payment.databinding.ActivityUpdateProductsBinding
...
class UpdateProductsActivity : AppCompatActivity() {
    private val TAG = "UpdateProductsActivity"
    private lateinit var binding: ActivityUpdateProductsBinding
    private val myPreferenceManager: MyPreferenceManager by lazy {
        MyPreferenceManager(this@UpdateProductsActivity)
    }
    ...
    private fun addEvents() {
        ...
        binding.btnUpdatePrduct.setOnClickListener {
            ...
            if (productName.nonEmpty() && productSize.nonEmpty() && productColor.nonEmpty()
                ...
                val call = retrofit.updateProduct(
                    token,
                    productItems.id,
                    productName,
                    productSize,
                ...
                call.enqueue(object: Callback<MessagesResponse> {
                    override fun onResponse(
                        ...
                        if (response.isSuccessful) {
                            ...
                            Log.e(TAG, "onResponse: ${messagesResponse?.message}")
                            ...
                            try {
                                ...
                                Log.e(TAG, "response fail: $errorMessage")
    ...
    private fun getDataFromIntent() {
        ...
        if (bundle != null){
            ...
            binding.edtProductName.setText(productItems.productName)
            binding.edtProductSize.setText(productItems.productSize)
            binding.edtProductColor.setText(productItems.productColor)
            binding.edtDiscountPrice.setText(productItems.discountPrice.toString())
            binding.edtSellPrice.setText(productItems.sellingPrice.toString())
            binding.edtDescription.setText(productItems.productDescription)
            binding.edtCategory.setText(productItems.categoryId.toString())
            binding.edtLinkImage.setText(productItems.productImg)
            binding.edtQuantity.setText(productItems.quantity.toString())
        }
    }
}